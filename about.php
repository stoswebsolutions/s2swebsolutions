        ...
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-lg-7">
                    ...
                    <p class="mb-4">
					S2S WEB SOLUTIONS started in 2017 as a full service professional web design firm specialized in responsive website design and development in Karimnagar. In 2018 company expanded its wing to Web Based web Development.
    ...
    <div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
        <div class="container py-5">
            <div class="section-title text-center position-relative pb-3 mb-5 mx-auto" style="max-width: 600px;">
                <h5 class="fw-bold text-primary text-uppercase">Our Team Members</h5>
