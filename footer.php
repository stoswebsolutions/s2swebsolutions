        ...
        <div class="container">
            <div class="row gx-5">
                <div class="col-lg-4 col-md-6 footer-about">
                    <div class="d-flex flex-column align-items-center justify-content-center text-center h-100 bg-primary2 p-4" style="margin-top:-30px;">
                        <a href="index.html" class="navbar-brand">
						<h1 class="m-0 text-white"><img src="img/logo.jpeg" style="width:30%; 
" alt="s2s web solutions logo" >
						</h1>
                        </a>
                        <p class="mt-3 mb-4">We offer the best website design and development services at Karimnagar to help clients improve their online presence using latest technology.Our solutions include CMS implementations, custom web programming, mobile-friendly, responsive websites, dynamic websites, eCommerce websites, web 2.0 programming, and custom database applications.</p>
                        <form action="">
                    ...
                    <div class="row gx-5">
                        <div class="col-lg-4 col-md-12 pt-5 mb-5">
                            ...
                            <div class="d-flex mb-2">
                                ...
                                <p class="mb-0">Karim Nagar, Telangana, India</p>
                            </div>
                            <div class="d-flex mb-2">
                                <i class="bi bi-envelope-open text-primary me-2"></i>
                                <p class="mb-0">contact@s2swebsolutions.com</p>
                            </div>
                            <div class="d-flex mb-2">
                                <i class="bi bi-telephone text-primary me-2"></i>
                                <p class="mb-0">+91 9703180922</p>
                            </div>
                            <div class="d-flex mt-4">
                                <a style="background-color: #F07724;border-color: #F07724;" class="btn btn-primary btn-square me-2" href="#"><i class="fab fa-twitter fw-normal"></i></a>
                                <a style="background-color: #F07724;border-color: #F07724;" class="btn btn-primary btn-square me-2" href="#"><i class="fab fa-facebook-f fw-normal"></i></a>
                                <a style="background-color: #F07724;border-color: #F07724;" class="btn btn-primary btn-square me-2" href="#"><i class="fab fa-linkedin-in fw-normal"></i></a>
                                <a style="background-color: #F07724;border-color: #F07724;" class="btn btn-primary btn-square" href="#"><i class="fab fa-instagram fw-normal"></i></a>
                            </div>
                        </div>
