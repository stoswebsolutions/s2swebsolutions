...
<head>
    <meta charset="utf-8">
    <title>Logo Designing at Karimnagar</title>
        ...
        <div class="container-fluid bg-primary py-5 bg-header" style="margin-bottom: 90px;">
            <div class="row py-5">
                <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                    <h1 class="display-4 text-white animated zoomIn">Logo Designing at Karimnagar</h1>
                    <a href="" class="h5 text-white">Services</a>
                    <i class="far fa-circle text-white px-2"></i>
                    <a href="" class="h5 text-white">Logo Designing at Karimnagar</a>
                </div>
            </div>
        </div>
    </div>
